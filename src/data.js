...
export const TRIP = {
  ...
  crew: [
    ...
    { name: "Christopher", role: "Classy Chap", note: "Lands FAT 4:10 PM Thursday", tag: "SFO", birthday: false },
    { name: "Thomas", role: "Classy Chap", note: "Lands FAT 4:00 PM Thursday", tag: "FAT", birthday: false },
    { name: "Hunter", role: "Stairmaster Champ", note: "\"Not many hills in New York\"", tag: "NY", birthday: false },
    { name: "Zaks", role: "Classy Chap", note: "Lands FAT 6:45 PM Thursday", tag: "FAT", birthday: false },
  ],
  ...
  flights: [
    ...
    },
    {
      name: "Christopher",
      birthday: false,
      arrival: { status: "PARTIAL", route: ["FAT"], day: "Thu Jun 18", arrive: "4:10 PM PDT" },
      departure: {
        status: "PARTIAL",
        route: ["SFO"],
        day: "Sun Jun 21",
        depart: "Red-eye Sun night",
        note: "Riding back to the Bay Area with Brett",
      },
    },
    {
      name: "Thomas",
      birthday: false,
      arrival: { status: "PARTIAL", route: ["FAT"], day: "Thu Jun 18", arrive: "4:00 PM PDT" },
      departure: { status: "PARTIAL", route: ["FAT"], day: "Sun Jun 21", depart: "10:45 AM PDT" },
    },
    {
      name: "Hunter",
      birthday: false,
    ...
    },
    {
      name: "Zaks",
      birthday: false,
      arrival: { status: "PARTIAL", route: ["FAT"], day: "Thu Jun 18", arrive: "6:45 PM PDT" },
      departure: {
        status: "PARTIAL",
        route: ["FAT"],
        carrier: "American",
        day: "Sun Jun 21",
        depart: "11:12 AM PDT",
        note: "Same flight out as DiBlasi (probably)",
      },
    },
  ],
  ...
  itinerary: [
    {
      ...
      items: [
        "Thomas & Chris land ~4 PM · Ryan 4:33 PM",
        "Zaks lands 6:45 PM · DiBlasi 9:52 PM",
    ...
    },
    {
      ...
      items: [
        ...
        "Thomas out 10:45 AM · DiBlasi & Zaks 11:12 AM · Ryan 12:29 PM",
        "Brett, Hunter & Chris hit the road",
